<!-- begin:: Footer -->
<div class="kt-footer kt-footer--extended kt-grid__item" id="kt_footer" style="background-image: url('<?= base_url('assets/media/bg/bg-2.jpg') ?>');">
            ...
            <div class="kt-footer__wrapper">
                <div class="kt-footer__logo">
                    ...
                    <div class="kt-footer__copyright">
                        <?= date('Y') ?>&nbsp;&copy;&nbsp;
                        <a href="#" target="_blank">Dirección Nacional de Cuentas Nacionales</a>
                    </div>
                </div>

                <div class="kt-footer__menu">
                    <a href="http://www.inei.gob.pe" target="_blank">Instituto Nacional de Estadística e Informática</a>
                </div>
            </div>
        </div>
    </div>
...
<script src="<?= base_url('assets/vendors/custom/jstree/jstree.bundle.js') ?>" type="text/javascript"></script>
...
<script src="<?= base_url('assets/js/pages/components/pivot/pivot.js') ?>" type="text/javascript"></script>
<script src="<?= base_url('assets/js/pages/components/pivot/pivot.es.js') ?>" type="text/javascript"></script>
<script src="<?= base_url('assets/js/pages/components/pivot/plotly_renderers.js') ?>" type="text/javascript"></script>
<script src="<?= base_url('assets/js/pages/components/pivot/excelexportjs.js') ?>" type="text/javascript"></script>
<!-- End Pivot -->
