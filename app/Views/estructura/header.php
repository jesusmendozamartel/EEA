...
<head>
    ...
    <title>.:DNCN-INEI:.Sistema de Consultas EEA</title>
    ...
    <link href="<?= base_url('assets/css/pivot.css') ?>" rel="stylesheet" type="text/css" />

    <!-- jstree: revisar ubicación -->
    <link href="<?= base_url('assets/vendors/custom/jstree/jstree.bundle.css') ?>" rel="stylesheet" type="text/css" />
