...
<script src="<?php echo base_url(); ?>vendor/jstree/jstree.bundle.js" type="text/javascript"></script>
...
<script src="<?php echo base_url(); ?>assets/js/pages/components/pivot/pivot.js" type="text/javascript"></script>
<script src="<?php echo base_url(); ?>assets/js/pages/components/pivot/pivot.es.js" type="text/javascript"></script>
<script src="<?php echo base_url(); ?>assets/js/pages/components/pivot/plotly_renderers.js" type="text/javascript"></script>
<script src="<?php echo base_url(); ?>assets/js/pages/components/pivot/excelexportjs.js" type="text/javascript"></script>
<!-- End Pivot -->
