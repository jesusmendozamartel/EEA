    ...
    $.fn.excelexportjs = function (options) {
        ...
        function Export(htmltable) {
            ...
            if (isBrowserIE()) {
                ...
                str=htmltable.replace(/"/g, '\'');
                str1=str.replace(/<th/gi,"<th style='font-size: 9pt;padding: 5px;background-color: #FFDA8C;border-style: solid;border-color: #a5a5ca';text-align: left;");
                str2=str1.replace(/<td/gi,"<td style='border: 1px solid #E4E3E3;font-size: 9pt;padding: 5px;border-style: solid;border-color: #a5a5ca;border-width: 1px;background-color: #FCFDC3;text-align: right;'");
                excelFile += "<head>";
