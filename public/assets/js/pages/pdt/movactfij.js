...
var MovActFij = function () {
    ...
    /*************************************************************************************/
    var MovActFijFormSubmit = function () {
        $("#form_search").validate({
            ...
            submitHandler: function (form) {
                $.ajax({
                    ...
                    type: "POST",
                    dataType: "html",
                    url: base_url + 'index.php/pdt/reporte_Maf/' + $('#periodo').val() + '/' + $('#grupo').val() + '/' + $('#nivel').val() + '/' + $('#dnivel').val() + '/' + $('#detalle').val() + '/0'+ '/' + $('#redondeo').val(),
    ...
    $("#ExpExcel").click(function () {
        ...
        window.location.href = base_url + 'index.php/pdt/reporte_Maf/' + $('#periodo').val() + '/' + $('#grupo').val() + '/' + $('#nivel').val() + '/' + $('#dnivel').val() + '/' + $('#detalle').val() + '/1'+ '/' + $('#redondeo').val();
